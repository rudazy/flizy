...
class TelegramApi {
  ...
  /**
   * Resolve a public username or chat id to a Chat object.
   * Used for claim-send: username → immutable user id at hold time.
   * @param {string|number} chatId e.g. "@alice_crypto" or numeric id
   */
  getChat(chatId) {
...
/** Inline keyboard from router button rows. `url` becomes a HTTPS open-link button. */
